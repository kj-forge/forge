...
// Extracted from the old plan-day drawer so the unit drawer (and anything
// else) can reuse the exact same surface.
  ...
  return (
    <div className="space-y-2">
      {picked.length > 0 ? (
        ...
        <p className="text-muted-foreground text-xs">Dodaj ćwiczenia w kolejności, w jakiej pojawią się w sesji.</p>
      )}
