...
| [ADR-0021](ADR-0021-training-plans-with-units-and-schedule-overrides.md) | Training plans as unit libraries with weekday activation and per-date schedule overrides | Proposed |
